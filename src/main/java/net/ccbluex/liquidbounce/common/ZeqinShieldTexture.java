...
public class ZeqinShieldTexture extends ReloadableTexture {

    public static final Identifier CLIENT_LOGO = Identifier.of("liquidbounce", "logo");
    public static final int WIDTH = 1280;
    public static final int HEIGHT = 768;

    public ZeqinShieldTexture() {
        super(CLIENT_LOGO);
    }

    @Override
    public TextureContents loadContents(ResourceManager resourceManager) {
        try (var stream = LiquidBounce.class.getResourceAsStream("/resources/liquidbounce/shield.png")) {
